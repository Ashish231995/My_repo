...
export function AdverseConditionPath() {
  ...
  return (
    <details className={styles.disclosure} data-testid="adverse-condition-path">
      <summary className={styles.summary} data-testid="demo-controls-summary">
        Demo controls
      </summary>
      <section className={styles.panel} aria-labelledby="adverse-condition-heading">
        <h3 id="adverse-condition-heading" className={styles.heading}>
          Adverse validation scenario (demonstration only)
        </h3>
