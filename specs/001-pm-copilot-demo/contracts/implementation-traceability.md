...
| FR-007 | `src/session/`, `src/features/reset-confirm/` | Integration | `tests/integration/reset-flow.test.tsx` | `session-state.md`, `ui-states.md` | P7, P9, P10 |
...
| FR-034 | `src/domain/recommendations/` | Unit + Golden | `tests/domain/order-recommendations.test.ts`; `tests/golden/sample-b.test.ts` (REC-002 before REC-001) | `recommendation-rules.md`, `golden-scenarios.md` | P5, P10 |
...
| FR-039 | `src/domain/persona/` | Unit + Integration | `tests/domain/persona-projection.test.ts`; `tests/integration/persona-tiers.test.tsx` | `domain-functions.md`, `ui-states.md` | P8, P10 |
...
| BR-015 | `src/features/reset-confirm/` | Integration | `tests/integration/reset-dialog.test.tsx` | `session-state.md` | P9, P10 |
...
| AS-020 | `src/domain/persona/` | Integration | `tests/integration/persona-invariance.test.tsx` | `domain-functions.md` | P10 |
| AS-021 | `src/domain/evaluation/` | Unit | `tests/domain/determinism.test.ts` | `evaluation-pipeline.md` | P10 |
| AS-022 | `src/domain/recommendations/` | Unit + Integration | `tests/domain/recommendation-rules.test.ts` | `recommendation-rules.md` | P10 |
...
| AS-054 | `src/features/invalid-project/` | Integration | `tests/integration/invalid-recovery.test.tsx` | `ui-states.md` | P10 |
| AS-055 | `src/domain/persona/` | Integration | `tests/integration/persona-tiers.test.tsx` | `ui-states.md` | P10 |
| AS-056 | `src/domain/persona/` | Integration | `tests/integration/persona-coaching.test.tsx` | `ui-states.md` | P10 |
| AS-057 | `src/domain/persona/`, `src/features/dimension-detail/` | Integration + A11y | `tests/integration/persona-tiers.test.tsx` | `ui-states.md` | P10 |
